...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    public OrderResponseDto saveOrder(OrderRequestDto orderRequestDto) throws BaseException {
        Customer customer = customerService.findCustomerByCustomerId(orderRequestDto.getCustomerId());
